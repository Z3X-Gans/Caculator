...
mengetik('.')
mengetik('.')
mengetik('menghubungi ./Z3X_ID..')
mengetik ('Please Wait !!')
mengetik ('WELCOME..!!')
mengetik ('kalo gak Tau Username Sama Password Bisa pm = 085816406954')
print
...
print(red),"###############################################"
time.sleep(0.23)
print(cyan),"Author         : ./Z3X_ID"
print(purple),"Github       : https://github.com/Z3X-Gans"
print(red),"Contact         : Bangrianda456@gmail.com"
print(blue),"Team         : Bojonegoro Cyber Security"
print(red),"Team           : 2Easy4Hack Team"
print(green),"###############################################"
time.sleep(0.23)
print(red),"###############################################"
